    ...
    return (
        <AlertDialog open={isOpen} onOpenChange={onOpenChangeAction}>
            <AlertDialogContent className="max-w-md">
                <AlertDialogHeader>
                    <AlertDialogTitle>{isEditing ? "Editar Endereço" : "Adicionar Endereço"}</AlertDialogTitle>
                </AlertDialogHeader>
                ...
                <Form {...formEditAddress}>
                    <form onSubmit={formEditAddress.handleSubmit(handleSubmit)}>
                        ...
                        <AlertDialogFooter>
                            <AlertDialogCancel onClick={handleCloseForm}>Cancelar</AlertDialogCancel>
                            <Button
                                type="submit"
                                disabled={[
                            ...
                            >
                                {formEditAddress.formState.isSubmitting && <Loader2 className="animate-spin mr-2" />}
                                Salvar
                            </Button>
                        </AlertDialogFooter>
                    </form>
