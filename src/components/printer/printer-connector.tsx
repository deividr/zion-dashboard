...
export function PrinterConnector({ onConnect, onDisconnect, onRefresh }: PrinterConnectorProps) {
    ...
    return (
        <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">{config.name || "Nenhuma impressora"}</span>
            </div>
            ...
            <div className="flex items-center gap-2">
                {isConnected ? (
                    <Button variant="outline" size="sm" onClick={handleDisconnect} disabled={isConnecting}>
                        Desconectar
                    </Button>
                ) : (
